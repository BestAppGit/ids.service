...
nft add rule ip filter INPUT tcp dport { 80, 443 } meter conn_meter { ip saddr ct count over 20 } counter reject
...
nft add rule ip filter INPUT tcp dport {80, 443} ct state new limit rate 3/second counter accept
